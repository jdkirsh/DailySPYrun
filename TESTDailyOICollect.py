...
def dailyOICollector():
    ...
    _fullurl = URL_PREFIX + DailyOIstd.next_thursdayAt17()
    print ("_fullurl=", _fullurl)
    driver.get(_fullurl)
    #driver.get("http://finance.yahoo.com/quote/SPY/options?ltr=1&straddle=true&date=1476403200")
    ...
    # table_df.columns = ['Index', 'ExpirationDate', 'CallsLastPrice', 'CallsVolume', 'CallsOI', 'Strike',
    #                     'PutsLastPrice', 'PutsVolume', 'PutsOI']

    table_df.to_csv('TESTSPYOIFile.csv', sep=',', encoding='utf=8')
